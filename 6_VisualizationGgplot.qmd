...
Para entender mejor esta geometría, utilizaremos el archivo `respiracion_long.csv`dentro de la carpeta `data` el cual contiene valores de consumo de oxígeno diario en un molusco marino bajo dos condiciones experimentales: **Control** y **Tratamiento**.
